...
namespace Nwazet.Commerce.Services.Combinations {
    ...
    public class InventoryControlPartDetailProvider :
        BaseCombinationDetailProvider {
        public InventoryControlPartDetailProvider(
        ...
        public override ContentTypeDefinitionBuilder AlterCombinationDefinition(
            ...
            if (containerDefinition != null
                && containerDefinition.Parts.Any(ctpd => ctpd.PartDefinition.Name == "InventoryControlPart")) {
                // alter the definition
                return previous.WithPart("InventoryControlPart");
            }
            return previous;
        }
    }
