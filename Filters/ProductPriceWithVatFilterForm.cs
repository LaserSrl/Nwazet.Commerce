...
namespace Nwazet.Commerce.Filters {
    public class ProductPriceWithVatFilterForm : IFormProvider {
        public Localizer T { get; set; }
        protected dynamic Shape { get; set; }
        private readonly Work<IResourceManager> _resourceManager;
        public ProductPriceWithVatFilterForm(IShapeFactory shapeFactory, Work<IResourceManager> resourceManager) {
            Shape = shapeFactory;
        ...
        public void Describe(DescribeContext context) {
            Func<IShapeFactory, dynamic> form =
                shape => {
                    var f = Shape.Form(
                        Id: "ProductPriceWithVatFilterForm",
            ...
            context.Form("ProductPriceWithVatFilterForm", form);
        }
    }
}
